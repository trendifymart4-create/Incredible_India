    ...
    >
        ...
        <div className="relative w-full h-full">
          ...
          <div
            ...
            style={{
              ...
              transform: 'scale(1.01)', // Slightly scale to remove black bars
              transformOrigin: 'center',
            }}
          />
          
          {/* Security overlay to prevent direct interaction with YouTube iframe */}
          <div
            ref={overlayRef}
      ...
      <AnimatePresence>
        {showControls && !hasError && controls && (
          <motion.div
            className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/60 to-transparent backdrop-blur-sm z-30"
      ...
      <AnimatePresence>
        {showSettings && (
          <motion.div
            className="absolute bottom-20 right-4 p-4 bg-black/90 backdrop-blur-sm rounded-lg border border-white/20 min-w-48 z-40"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
          >
